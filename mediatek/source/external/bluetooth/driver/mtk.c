...
#define LOG_TRC printf
#define LOG_ERR printf 
#define LOG_DBG printf 
#define CUST_BT_SERIAL_PORT "/dev/ttyBt"
...
printf ("Read NVRAN %d\n",sizeof(ap_nvram_btradio_mt6610_struct)); 
...
#else
    printf("[BDAddr %02x-%02x-%02x-%02x-%02x-%02x][CapId %02x][LinkKeyType %02x] \
...
printf ("Init Device\n");
    ...
    if(BT_InitDevice(
        ...
        printf("Initialize BT device fails\n");        
        goto error;
    }
